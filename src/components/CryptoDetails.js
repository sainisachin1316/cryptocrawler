...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div onClick={close} className="fixed top-0 w-full h-full bg-gray-300 bg-opacity-30 first-letter: backdrop-blur-sm flex items-center justify-center font-nunito z-40">
        
        <div onClick={(e)=> e.stopPropagation()} className="lg:w-[75%] lg:h-[75%] md:w-[90%] md:h-[75%] w-[90%] h-[90vh] scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-gray-200 bg-white bg-opacity-75 rounded-lg text-gray-200 relative">
            {
                data ? ( 
                    ...
                    <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
                        ...
                        <div className="flex flex-col md:w-[45%] w-full h-full pr-2 ">
                            ...
                            <div className="flex w-full items-center">
                                ...
                                <span className="text-sm py-0.5 px-2.5 ml-2 bg-gray-300 text-white bg-opacity-25 rounded uppercase">{data.symbol}</span>
                            </div>
                            ...
                            <div className="flex sm:flex-row flex-col w-full mt-4 justify-between">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm sm:mt-0 mt-3 capitalize text-gray-100">fully diluted valuation</span>
                                    <h2 className="text-base font-bold">{ new Intl.NumberFormat("en-IN",{
                                            style: "currency",
                                            currency: currency,
                                            notation: "compact",
                            ...
                            <div className="flex sm:flex-row flex-col w-full mt-4 justify-between">
                                <div className="flex flex-col">
                                    <a
                                        target={"_blank"}
                                        rel="noreferrer"
                                        className="text-sm bg-gray-100 text-white px-1.5 py-0.5 my-1 rounded"
                                ...
                                <div className="flex flex-col content-start sm:mt-0 mt-5">
                                    <span className="text-sm capitalize text-gray-100">Sentiments</span>

                                    
                                    <div className="flex justify-between">
                                        
                                        <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center
                                            ...
                                            <svg className={`w-[1rem] ml-0.5 fill-red`} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z"/>
                                            </svg>
                                        </div>
                                    </div>
                        ...
                        <div className='flex flex-col md:w-[55%] w-full h-full md:pl-4 pl-0 md:mt-0 mt-2'>
                            <Chart id={data.id}/>

                            <div className="flex flex-col mt-20">
                                <h3 className=" py-1">
                                <span className="text-gray-200 capitalize mr-1">
                                    market cap rank:{" "}
                                </span>{" "}
                                ...
                                {data.market_data.market_cap_fdv_ratio && (
                                    <h3 className=" py-1">
                                    <span className="text-gray-200 capitalize mr-1">
