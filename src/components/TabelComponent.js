            ...
            <tbody>
                ...
                {cryptoData.map(data=>{
                    return(
                        ...
                        <tr key={data.id} className='text-center text-base border-b border-gray-100 hover:bg-gray-100 hover:text-white hover:bg-opacity-35 last:border-b-0 '>
                            
                            <td className='py-4 flex items-center uppercase'>
                                
                                <SaveBtn data={data}/>
                                
                                <img src={data.image} alt={data.name} className='w-[1.7rem] ml-3 mr-1' />
