...
const Trending = () => {
  ...
  return (
    <section className='w-[80%] h-full flex flex-col mx-auto mt-16 mb-24 relative'>
      <div className='md:py-10 md:text-lg mb-10 text-md text-center text-gray-100 font-nunito '>
      Follow the Trend, Seize the Opportunity: Explore the Hottest Cryptocurrencies Making Waves in the Market.
        <hr className='mt-8 border-gray-100' />
      </div>
      <div className=' w-full min-h-[60vh] py-8 flex lg:flex-row flex-col items-center flex-wrap justify-evenly mt-9 border border-gray-100 rounded'>
