...
const Watchlist = () => {
  ...
  return (
    <section className="w-[80%] h-full flex flex-col mx-auto mt-16 mb-24 relative">
      <div className='md:py-10 md:text-lg mb-14 text-md text-center text-gray-100 font-nunito '>
      Stay Ahead, Stay Informed: Your Personalized Crypto Watchlist for Smart Portfolio Management.
      ...
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {savedData ? (
              ...
              {savedData &&
                savedData.map((data) => {
                  return (
                    <tr
                      key={data.id}
                      className='text-center text-base border-b border-gray-100 hover:bg-gray-100 hover:text-white hover:bg-opacity-35 last:border-b-0 '
                    >
                      ...
                      <td className='py-4 md:table-cell hidden'>{Number(data.market_cap_change_percentage_24h).toFixed(2)}%</td>
                      <td className={data.price_change_percentage_1h_in_currency >= 0 ? 'text-green py-4 sm:table-cell hidden' : 'text-red py-4 sm:table-cell hidden'}>{Number(data.price_change_percentage_1h_in_currency).toFixed(2)}%</td>
          ...
          <h1 className="min-h-[60vh] text-lg text-gray-200 flex items-center justify-center">
        ...
        absolute right-0 -top-10 hidden
        "
